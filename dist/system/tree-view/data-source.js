System.register(["aurelia-binding", "aurelia-logging", "./node-model"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_binding_1, aurelia_logging_1, node_model_1, DataSourceApiImplementation, DataSource;
    return {
        setters: [
            ...
            function (node_model_1_1) {
                node_model_1 = node_model_1_1;
            }
        ],
        execute: function () {
            DataSourceApiImplementation = (function () {
            ...
            DataSource = (function () {
                function DataSource(taskQueue) {
                    ...
                    this.log = aurelia_logging_1.getLogger('aurelia-tree-view/data-source');
                    this.selectedNodes = [];
                    this.settings = {
                ...
                DataSource.prototype.setNodeSelection = function (node, isSelected, setChildren, recurse) {
                    ...
                    var promise;
                    if (node instanceof node_model_1.NodeModel) {
                        expandPath = true;
                ...
                DataSource.prototype.visitNode = function (item, parent) {
                    ...
                    if (this.validateNode(item)) {
                        ...
                        if (nodeFound) {
                            ...
                            node_1 = new node_model_1.NodeModel(parent);
